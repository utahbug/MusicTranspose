const CACHE='music-transpose-v114-'+self.registration.scope;
const SCORE_CACHE=CACHE+'-scores';
// Fallback PDFs are intentionally absent from install/warm lists: cache on first open.
const ASSETS=["./system-pagination.js", "./hymn-melody.js", "./lead-layout.js", "./octave.js", "./metronome.js", "./pdf-fallbacks.js", "./playback-settings.js", "./auto-layout.js", "./icons.js", "./files-view.js", "./lists-view.js", "./catalog.js", "./local-music-store.js", "./local-music-validation.js", "./my-music.js", "./", "./index.html", "./manifest.webmanifest", "./assets/icons/favicon.svg", "./assets/icons/favicon-32.png", "./assets/icons/apple-touch-icon.png", "./assets/icons/icon-192.png", "./assets/icons/icon-512.png", "./styles.css", "./app.js", "./lyric-placement.js", "./playback.js", "./pdf-score.js", "./vendor/pdf.min.js", "./vendor/pdf.worker.min.js", "./library.js", "./view-history.js", "./library-query.js", "./lyrics-view.js", "./lyrics-hold.js", "./lyrics-fun.js", "./lyrics-fun-ambient.js", "./lyrics-index.js", "./assets/lyrics.json", "./list-reorder.js", "./score-layout.js", "./opening-metadata.js", "./navigation.js", "./score-taps.js", "./settings-help.js", "./virtual-pages.js", "./music.js", "./lead-view.js", "./lead-availability.js", "./chord-symbol.js", "./instrument-keys.js", "./title-alignment.js", "./songs.js", "./imported-songs.js", "./vendor/opensheetmusicdisplay.min.js", "./vendor/fflate.min.js", "./offline-scores.json"];
