...
const items=['index.html','styles.css','app.js','library.js','score-layout.js','navigation.js','music.js','songs.js','imported-songs.js','sw.js','manifest.webmanifest','robots.txt','assets','vendor','.nojekyll'];
