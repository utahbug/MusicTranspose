import {setVirtualSource,resetVirtualSource,virtualAvailable,virtualFrames,prepareVirtualPages,displayVirtual} from './virtual-pages.js';
...
let mode=['continuous','auto','pages'].includes(saved.mode)?saved.mode:'continuous';
...
function syncPages(){
 ...
 $('page-mode-note').textContent=available?'Tap the left or right half of a page, or use the page buttons / arrow keys.':'Load a score to prepare performance pages.';
